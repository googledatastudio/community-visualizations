...
function parseData(message) {
  ...
  render(root, parsedStyle, colorScale);
}
...
function render(root, style, colorScale) {
  ...
  if (style.showL1Labels) {
    nodes
      .append('text')
      .filter(function(d) {
        return d.depth === 1;
      })
      .attr('dx', +style.textXOffset)
      .attr('dy', +style.textYOffset)
      .attr('fill', style.fontColor.color)
